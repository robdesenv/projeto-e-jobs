                ...
                <div class="form-section">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="formacao" class="form-label">Formações:</label>
                                <input type="text" name="formacoes" class="form-control" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="cargos" class="form-label">Cargos:</label>
                                <input type="text" name="cargos" class="form-control" required>
                            </div>
                            <div class="col-md-6 mb-3">
